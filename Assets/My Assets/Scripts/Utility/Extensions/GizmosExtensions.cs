...
namespace Utils
{
    public static class GizmosExtensions
    {
        ...
        public static void DrawArrow(Vector3 from, Vector3 to, Color color = default, float arrowHeadLength = 0.25f,
        ...
        /// </summary>
        public static void DrawWireCircle(Vector3 center, float radius, int segments = 20, Color color = default,
            Quaternion rotation = default)
        {
            DrawWireArc(center, radius, 360, segments, color, rotation);
        }
        ...
        public static void DrawWireArc(Vector3 center, float radius, float angle, int segments = 20, Color color = default,
        ...
        public static void DrawWireArcRelativeToForward(Vector3 center, float radius, float angle, int segments = 20, Color color = default,
            Quaternion rotation = default)
        {
            ...
            // Arc goes from -halfAngle to +halfAngle
            float halfAngle = angle * 0.5f;
            float step = angle / segments;

            Vector3 from = new Vector3(
                radius * Mathf.Sin(-halfAngle * Mathf.Deg2Rad), 
                0, 
                radius * Mathf.Cos(-halfAngle * Mathf.Deg2Rad)
            );
        ...
        /// <param name="showCast"></param>
        public static void DrawBoxCast(
            Vector3 center, Vector3 halfExtents, Vector3 direction, Quaternion orientation, float maxDistance, int layerMask,
            bool showCast)
        {
            // calculate vars
            ...
            if (showCast && Physics.BoxCast(center, halfExtents, direction, out RaycastHit hitInfo, orientation, maxDistance,
                    layerMask))
            {
